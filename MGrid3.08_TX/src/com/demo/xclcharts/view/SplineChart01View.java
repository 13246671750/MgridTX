...
public class SplineChart01View extends TouchView {
	...
	private void chartRender()
	{
		...
		//	plot.setHorizontalLineStyle(XEnum.LineStyle.DOT);
			...
			chart.getCategoryAxis().getTickMarksPaint().setColor(
					plot.getHorizontalLinePaint().getColor());
			chart.getDataAxis().getTickLabelPaint().setColor(Color.parseColor("#1AC40D"));
			chart.getCategoryAxis().getTickLabelPaint().setColor(Color.parseColor("#1AC40D"));
	...
	private void chartDataSet()
	{
		...
		SplineData dataSeries1 = new SplineData("java",linePoint1,
		...
		dataSeries1.getDotLabelPaint().setColor(Color.parseColor("#A9A9A9"));
		dataSeries1.getDotLabelPaint().setTextSize(30);
		//线2的数据集
		...
		dataSeries2.getDotLabelPaint().setColor(Color.parseColor("#A9A9A9"));
