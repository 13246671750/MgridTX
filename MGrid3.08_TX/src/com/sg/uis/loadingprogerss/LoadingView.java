package com.sg.uis.loadingprogerss;
...
//        }, 900);
    ...
    public void finishXml()
    {
          ...
          LinearLayout lin=(LinearLayout) view.findViewById(R.id.lin_dia);
          
          
          mShapeLoadingView = new ShapeLoadingView(getContext());
          lin.addView(mShapeLoadingView);
          mIndicationIm = (ImageView) view.findViewById(R.id.indication);
          mLoadTextView = (TextView) view.findViewById(R.id.promptTV);
