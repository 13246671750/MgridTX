...
public class SgCircleChart extends TextView implements IObject {

	public SgCircleChart(Context context) {
		super(context);


		m_oPaint = new Paint();
		m_rBBox = new Rect();
       chart02View=new CircleChart02View(context);
	...
	public void doLayout(boolean bool, int l, int t, int r, int b) {
		...
		if (m_rRenderWindow.isLayoutVisible(m_rBBox)) {
			...
			chart02View.layout(nX, nY, nX + nWidth, nY + nHeight);
		}
	}
	...
	CircleChart02View chart02View=null;
