...
public class SgBrokenLine extends TextView implements IObject {
	...
	private HashMap<Double, Double> dataHash = new HashMap<Double, Double>(); // 一根线上的一个点
	// private List<Integer> dataList=new ArrayList<Integer>(); //一根线的数据
	private List<List<Integer>> partList = new ArrayList<List<Integer>>(); // 所有线的数据总集合
